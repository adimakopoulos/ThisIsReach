...
namespace SimpleWorldGenerationNS
{
    ...
    public class WorldGenerationsManager : MonoBehaviour
    {
        ...
        [Range(1, 100)]
        public const int widthOfTile = 1;
        ...
        public static TileData GetTile(Vector3Int pos) {
            if (worldMatrix.TryGetValue(pos, out TileData tile))
                return tile;
        ...
        {
            if (instance != null) {
                Debug.LogWarning("instance was already set. Overwriting it");
            }
            instance = this;
        }
        ...
        public void DeleteTiles()
        {
            ...
            {
                if (tile.name.StartsWith("Tile| x:"))
                {
